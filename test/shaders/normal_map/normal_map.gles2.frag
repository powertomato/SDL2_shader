...
void main() {
    ...
    vec4 DiffuseColor = texture2D(u_texture, texCoord_out.st);

    //RGB of our normal map
    vec3 NormalMap = texture2D(u_normals, texCoord_out.st).rgb;
    ...
    gl_FragColor = col_out * vec4(FinalColor, DiffuseColor.a);
}
